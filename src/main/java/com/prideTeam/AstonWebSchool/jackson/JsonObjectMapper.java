package com.prideTeam.AstonWebSchool.jackson;
...
public class JsonObjectMapper extends ObjectMapper {
     ...
     * модуль для корректной сериализации LocalDate в поля JSON - JavaTimeModule модуль библиотеки jackson-datatype-jsr310
